...
import Mtablemenu from './m-table-menu';
...
export class MTableHeader extends React.Component {
                ...
                >
                  { 
                    ...
                    <Mtablemenu
                      columnDef = { columnDef }
                      state = {this.state}
                      inherit = {this.props.theme.palette.primary.main}
                      component = {this.props.icons.Menu}
                      prop = {this.props}
                      ispinRightValue = {this.props.options.PinRight}
                      ispinLeftValue = {this.props.options.PinLeft}
                      isUnpin = {this.props.options.Unpin}
                      isFilter = {this.props.options.Filter}
                      isSortDesc = {this.props.options.SortDesc}
                      isSortAesc = {this.props.options.SortAesc}
                    />
                    </div>
                  }
                </div>
  ...
  render() {
    ...
    return (
      <TableHead>
        { this.props.options.ToogleMenuButton &&<Switch  onClick = {() => this.handleSwitch()} defaultChecked /> }
